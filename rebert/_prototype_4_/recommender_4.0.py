...
# -*- coding: utf-8 -*-
# 
#   FILE: recommender_4.0.py
#   REVISION: October, 2024
#   CREATION DATE: October, 2024
#   Author: David W. McDonald
#
#   First cut web app launcher
#
#{{RELEASE}}
#
#{{COPYRIGHT_NOTICE}}
...
SERVER_PORT = 5000
SERVER_SETUP_DELAY = 5.0        # wait 5 seconds before launching browser
SERVER_APP = "web/wsgi"
...
#   this program will accept. This is specific to the Args() class.
PARAMS_TEMPLATE = {
    "-browser" : {
            ...
            "options"   : BROWSER_NAMES     # a list of browsers that python knows
        },
    "-delay" : {
            "required"  : False, 
            "type"      : float, 
            "notes"     : "<delay before browser launch>", 
    ...
    "-mockup" : {
            "required"  : False,  
            "type"      : bool,  
            "notes"     : "<show the mockup of this prototype>", 
    ...
    "-port" : {
            ...
            "type"      : int, 
            "notes"     : "<server port>", 
            "default"   : SERVER_PORT   # server on this default port
        },
    "-app" : {
            "required"  : False, 
            "type"      : str, 
...
def main():
    ...
    #   the rebert data already exists or if we're just showing the mockup
