...
OAI_MODEL = "gpt-5.4-mini-2026-03-17"
#
...
def main():
    ...
    while len(user_text)>0 and (user_text.lower() != "quit"):
        ...
        #   Use two variables to unpack the return value
        chat_context, usage = make_chat_request(user_text, chat_context, API_KEY)

        #   Add each request’s usage into the running totals
        ...
        user_text = input(f"You > ").strip()
        print()
    print('Session total usage:', json.dumps(total_usage, indent=2))
    return
