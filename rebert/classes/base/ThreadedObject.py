...
# -*- coding: utf-8 -*-
# 
#   FILE: ThreadedObject.py
#   REVISION: March, 2024
#   CREATION DATE: August, 2017
#   Author: David W. McDonald
#
#   A base class for the threaded objects in the class library
#
...
class Object(Thread):
    '''
    A base Object class that provides configurable debugging and logging. A subclass of Thread.
    ...
    Attributes:
        ...
        running         : a boolean flag as to whether this thread is currently running
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.disable_debug = True          # by default threaded objects start with output suppressed
        self.daemon = False
        self.running = False
        self.name = "ThreadedObject"
        self.logger = None
...
if __name__ == '__main__':
    print("ThreadedObject.py has no main()")
